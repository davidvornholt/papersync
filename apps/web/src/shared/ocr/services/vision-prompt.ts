...
Preserve wording, abbreviations, accents, umlauts, and ß. Set isCompleted only when the paper clearly marks the entry done. Use subject "General Tasks" for entries without a subject.
