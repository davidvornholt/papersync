...
export const vaultOptions: ReadonlyArray<ToggleOption> = [
  {
    value: 'local',
    label: 'Local filesystem',
    description: 'Folder on the PaperSync server',
    icon: (
      <svg
        className="size-4"
        fill="none"
  ...
  {
    value: 'super-productivity',
    label: 'Super Productivity',
    description: 'Import approved homework with the plugin',
    icon: (
      <svg
        className="size-4"
        fill="none"
